...
export const headerNavMenus: HeaderNavMenu[] = [
  {
    ...
    label: "Residential",
    href: "/residential",
    featured: { label: "Overview", href: "/residential" },
    groups: [
      {
        items: [
          { label: "CCTV", href: "/systems/home-cctv" },
          ...
          { label: "Intruder Servicing", href: "/service-plans/alarm-maintenance" },
  ...
  },
  {
    ...
    featured: { label: "Overview", href: "/fire-compliance" },
    groups: [
      {
        heading: "Fire Systems",
        items: [
          { label: "Installation", href: "/systems/fire-safety" },
          { label: "Servicing", href: "/service-plans/fire-alarm-servicing" },
          { label: "Repairs & Takeovers", href: "/services/fire-alarm-repairs-takeovers" },
          { label: "Multi-Site Systems", href: "/fire-compliance/multi-site-fire-alarm-systems" },
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Compliance Plans", href: "/service-plans/fire-compliance" },
        ],
      },
    ],
  },
  {
    ...
    label: "Commercial",
    href: "/commercial",
    featured: { label: "Overview", href: "/commercial" },
    groups: [
      {
        heading: "Systems",
        items: [
          { label: "CCTV", href: "/commercial/cctv" },
          { label: "Intruder Alarms", href: "/commercial/intruder-alarms" },
  ...
  },
  {
    ...
    href: "/service-plans",
    featured: { label: "Overview", href: "/service-plans" },
    groups: [
      {
        items: [
