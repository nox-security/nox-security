...
export const localLandingPages: Record<string, LocalLandingPage> = {
  "cctv-installation-chesterfield": {
    ...
    title: "CCTV Installation in Chesterfield for Properties and Businesses",
    metaTitle: "CCTV Installation Chesterfield | NOX CCTV Installers",
    metaDescription: "Professional CCTV Installation in Chesterfield for properties, shops, hospitality, offices and industrial sites, with recording, remote viewing and maintenance.",
    intro: "NOX provides CCTV Installation in Chesterfield, designing camera positions, recording and remote access around the property, the areas that matter and the footage that may need to be recovered later.",
  ...
  "intruder-alarm-installation-chesterfield": {
    ...
    title: "Intruder Alarm Installation in Chesterfield",
  ...
  "commercial-cctv-sheffield": {
    ...
    title: "Commercial CCTV Installation for Sheffield Businesses",
    metaTitle: "Commercial CCTV Installation Sheffield | NOX",
    metaDescription: "Commercial CCTV Installation in Sheffield and South Yorkshire for offices, retail, warehouses, industrial units, yards, hospitality and multi-site businesses.",
  ...
  "cctv-installation-derbyshire": {
    ...
    title: "CCTV Installation Across Derbyshire",
    metaTitle: "CCTV Installation Derbyshire | Home & Commercial CCTV",
    metaDescription: "Professional CCTV Installation across Derbyshire for properties, hospitality, retail, offices, yards and industrial sites, with recording, remote viewing and maintenance.",
  ...
  "fire-alarm-installation-chesterfield": {
    ...
    title: "Commercial Fire Alarm Installation in Chesterfield",
    metaTitle: "Fire Alarm Installation Chesterfield | Commercial Systems",
    metaDescription: "Commercial Fire Alarm Installation in Chesterfield using conventional, addressable and suitable Ajax EN54 systems, with commissioning and future servicing.",
  ...
  "fire-alarm-servicing-chesterfield": {
    ...
    title: "Fire Alarm Servicing in Chesterfield",
    metaTitle: "Fire Alarm Servicing Chesterfield | Commercial Maintenance",
    metaDescription: "Fire Alarm Servicing in Chesterfield for commercial premises, landlords and portfolios, with system testing, records, defect reporting, repairs and takeovers.",
  ...
  "security-system-takeover": {
    ...
    imageAlt: "Older commercial CCTV camera assessed during a NOX system takeover",
  ...
  "fire-alarm-repairs-takeovers": {
    ...
    metaDescription: "Fire alarm repairs and takeover assessments across Chesterfield, Sheffield and Derbyshire, covering faults, records, supportability, remedials and maintenance.",
    ...
    imageAlt: "Fire alarm equipment base and cabling during a repair or takeover assessment",
    location: "Chesterfield, Sheffield & Derbyshire",
    audience: "Commercial",
  ...
  "fire-extinguisher-servicing": {
    ...
    metaDescription: "Fire extinguisher servicing across Chesterfield, Sheffield and Derbyshire, with asset records, defect reporting and coordinated compliance support.",
    ...
    image: "/images/v4-12-3/fire-extinguisher-servicing.jpg",
    imageAlt: "Fire extinguishers positioned in a commercial premises for servicing and compliance support",
    location: "Chesterfield, Sheffield & Derbyshire",
    audience: "Commercial",
  ...
  "repairs-upgrades": {
    ...
    metaDescription: "Repairs and upgrades for suitable alarm, CCTV and fire systems across Chesterfield, Sheffield and Derbyshire, including faults and phased replacement.",
    ...
    image: "/images/image-refresh/chester-street-before.webp",
    imageAlt: "Existing multi-camera CCTV system with several failed video channels before an upgrade",
    location: "Chesterfield, Sheffield & Derbyshire",
    audience: "Residential & Commercial",
