...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: "/images/revisions/telesis-fire-call-point-1.jpg", alt: "Fire alarm manual call point installed at the Telesis industrial premises" },
      ...
      { src: "/images/revisions/telesis-fire-call-point-2.jpg", alt: "Close view of a manual fire call point at Telesis" }
    ],
  ...
  },
  {
    ...
    gallery: [
      { src: "/images/revisions/buxton-commercial-cctv-monitor.jpg", alt: "Nine-camera CCTV live view at an industrial premises in Buxton" }
    ],
...
export const systemPages: Record<string, ServicePageData> = {
  "intrusion-alarms": {
    ...
    imageAlt: "NOX branded Ajax intruder alarm equipment prepared for a tailored installation",
    ...
    products: [
      { name: "Ajax Hub", description: "The control centre connecting detectors, users, communication channels, app control and compatible visual-verification devices. The hub is selected around the property and system size.", image: "/images/ajax-products/ajax-hub.webp", imageAlt: "Ajax Hub smart alarm control panel in black and white" },
      { name: "MotionCam", description: "Wireless motion detection with photo verification on suitable systems. Selected models offer detection coverage of up to 12 metres, with the final device chosen around room layout and risk.", image: "/images/ajax-products/ajax-motioncam.webp", imageAlt: "Official black Ajax MotionCam detector with photo verification" },
      { name: "DoorProtect", description: "Opening detection for doors and windows, positioned around real entry routes, night mode and the way the household or business uses the property.", image: "/images/ajax-products/ajax-doorprotect.webp", imageAlt: "Black and white Ajax DoorProtect opening detectors" },
      { name: "Ajax keypads and controls", description: "KeyPad Plus and KeyPad TouchScreen options provide clear arming, group and scenario control, with compatible authentication by smartphone, Pass, Tag or code.", image: "/images/ajax-products/ajax-keypad-plus.webp", imageAlt: "Official Ajax keypad and system control product image" },
      { name: "Curtain and outdoor detection", description: "MotionProtect, MotionCam and selected curtain-style outdoor detectors are combined only where the survey shows they add useful protection.", image: "/images/ajax-products/ajax-curtain-outdoor.webp", imageAlt: "Ajax curtain-style detector for selected internal and external protection" },
      { name: "Ajax StreetSiren and aftercare", description: "A professionally positioned external siren provides a visible deterrent, while monitoring and annual maintenance can be added after handover.", image: "/images/ajax-products/ajax-streetsiren.webp", imageAlt: "Official Ajax StreetSiren product image" }
    ],
    videos: [
  ...
  "emergency-lighting": {
    ...
    imageAlt: "Commercial emergency lighting installation designed around escape routes",
  ...
  "home-cctv": {
    ...
    metaDescription: "Home CCTV installation across Chesterfield, Sheffield, Derbyshire and South Yorkshire for driveways, entrances, gardens, garages and outbuildings, with recording and remote viewing.",
...
export const planPages: Record<string, PlanPageData> = {
  ...
  "cctv-maintenance": {
    ...
    image: "/images/revisions/buxton-commercial-cctv-monitor.jpg",
  ...
  "fire-compliance": {
    ...
    imageAlt: "Fire safety logbook and system plans used for commercial compliance records",
