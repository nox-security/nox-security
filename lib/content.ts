...
export const systemPages: Record<string, ServicePageData> = {
  "intrusion-alarms": {
    ...
    products: [
      ...
      { name: "Curtain and outdoor detection", description: "MotionProtect, MotionCam and selected curtain-style outdoor detectors are combined only where the survey shows they add useful protection.", image: "/images/SingleCurtain.jpeg", imageAlt: "Ajax curtain-style detector for selected internal and external protection" },
  ...
  cctv: {
    ...
    title: "CCTV designed for dependable coverage, recording and playback",
    ...
    intro: "Professional residential and commercial CCTV uses fixed cameras with a dedicated NVR or DVR, giving stronger whole-property coverage, dependable recording, playback and remote viewing. NOX installs Ajax CCTV, Hikvision ColourVu and other suitable platforms around the scene, lighting, network and evidence requirement.",
    ...
    problemTitle: "Professional CCTV is built around the footage you may need to recover later",
    ...
    products: [
      ...
      { name: "Ajax NVR and recording", description: "Ajax NVR is available in 8- and 16-channel versions. Storage, recording mode and retention are selected around camera count, resolution and the project requirement.", image: "/images/projects/bottle-thyme-monitor-wide.jpg", imageAlt: "Professional CCTV recording and live viewing installed by NOX in Chesterfield" },
      { name: "Ajax video ecosystem", description: "Ajax cameras, compatible third-party IP cameras and video entry can be brought into the wider Ajax platform where network, permissions and recording requirements support it.", image: "/images/ajax-camera.webp", imageAlt: "Black Ajax professional video camera" },
  ...
  "fire-safety": {
    ...
    products: [
      { name: "EN54 Fire Hub Jeweller", description: "Touchscreen control and indicating equipment for the Ajax EN54 fire line, selected and configured as part of a complete fire-system design.", image: "/images/revisions/ajax-en54-fire-control-panel.jpg", imageAlt: "Ajax EN54 Fire Hub touchscreen fire alarm panel" },
  ...
  "emergency-lighting": {
    ...
    imageAlt: "Illuminated emergency exit sign for installation and testing in Derbyshire",
  ...
  "fire-risk-assessment": {
    ...
    imageAlt: "Fire safety logbook and property plans used during compliance support",
...
export const planPages: Record<string, PlanPageData> = {
  ...
  "cctv-maintenance": {
    ...
    imageAlt: "Engineer removing existing CCTV cameras during a system takeover and upgrade",
    residentialPrice: "£225 per year",
    commercialPrice: "From £295 per year",
