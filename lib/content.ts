...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    summary: "A coordinated commercial fire and Ajax intruder upgrade for Banana Industries in Sheffield.",
    metaTitle: "Commercial Fire & Intruder Installation Sheffield | NOX",
    metaDescription: "A coordinated commercial fire and Ajax intruder alarm upgrade for Banana Industries in Sheffield, delivered and handed over by the local NOX team.",
    story: "Banana Industries required a clearer, modern security route alongside its fire protection. NOX upgraded the existing intruder arrangement to Ajax equipment and coordinated the wider fire and security work through one local project team.",
    requirement: "Upgrade the existing commercial intruder protection and coordinate the security work alongside the premises' fire-safety requirements.",
    delivery: "NOX replaced the ageing intruder controls with a modern Ajax system, installed the external NOX siren and completed the coordinated fire and security handover.",
    systems: ["Ajax commercial intruder alarm", "Existing-system upgrade", "External NOX siren", "Fire protection", "Joined-up installation"],
    gallery: [
      { src: "/images/v4-13-12/banana-industries/site-sign.jpg", alt: "Banana Industries sign at the Sheffield commercial premises", caption: "The Banana Industries premises in Sheffield, where NOX coordinated the intruder upgrade and wider fire and security work." },
      { src: "/images/v4-13-12/banana-industries/legacy-keypad.jpg", alt: "Older 57systems alarm keypad before the Banana Industries intruder upgrade", caption: "The existing alarm controls were reviewed before the new Ajax equipment and user setup were introduced." },
      { src: "/images/v4-13-12/banana-industries/ajax-equipment-siren.jpg", alt: "NOX branded Ajax siren, hub and keypad prepared for the Banana Industries installation", caption: "The new Ajax equipment was prepared and configured around the commercial premises and the staff using the system." },
      { src: "/images/v4-13-12/banana-industries/ajax-equipment-layout.jpg", alt: "Ajax keypad, detectors and door contacts laid out for the Banana Industries intruder alarm", caption: "Keypads, movement detectors and opening protection formed the modernised commercial intruder system." },
      { src: "/images/v4-13-12/banana-industries/completed-nox-siren.jpg", alt: "Black NOX branded Ajax external siren installed at Banana Industries in Sheffield", caption: "The completed external siren provides a visible NOX security presence and clear local warning at the premises." }
    ],
    searchKeywords: ["commercial fire and security Sheffield", "Ajax commercial alarm Sheffield", "fire alarm installation South Yorkshire", "business intruder alarm upgrade"],
    designPriorities: [
      "Assess the inherited alarm equipment and replace ageing controls with a modern Ajax system suited to the daily operation of the premises.",
      "Coordinate commercial intruder and fire protection through one project while retaining clear functions, records and future service routes for each system.",
      "Complete the keypad, detector, external siren and user setup with a practical handover for the people responsible for opening, closing and managing the site.",
    ],
    outcome: "Banana Industries received a modern Ajax commercial intruder upgrade alongside coordinated fire protection, with new controls, detection, an external NOX siren and a clear ongoing-support route.",
    localContext: "Businesses across Sheffield and South Yorkshire often inherit older alarm equipment alongside separate fire-safety requirements. A coordinated survey can identify what should be replaced or retained while keeping the fire and intruder systems correctly separated in testing, records and servicing.",
    faq: [
