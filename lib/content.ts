...
export const systemPages: Record<string, ServicePageData> = {
  "intrusion-alarms": {
    ...
    imageAlt: "Ajax MotionCam with photo verification protecting a commercial or residential property",
  ...
  "perimeter-protection": {
    ...
    image: "/images/image-refresh/home-perimeter-motioncam.webp",
