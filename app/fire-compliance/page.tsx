...
export default function FireCompliancePage() {
  return <>
    ...
    <section className="section"><div className="container split-grid"><div>
      <SectionHeading eyebrow="Why separate the services" title="Installation, servicing and remedials answer different customer needs" text="A new fire alarm page should help a customer plan a system. A servicing page should explain testing, records and recurring visits. A repairs page should deal with faults, access and supportability. Keeping those intentions separate makes the next action clearer and protects search relevance."/>
    ...
    <section className="section"><div className="container"><SectionHeading eyebrow="Customer feedback" title="Clear installation, handover and local support"/><ReviewGrid limit={3}/></div></section>
    <ConversionPanel title="Discuss a fire installation, service or takeover" text="Tell us about the premises, existing equipment and the work required. NOX will guide the enquiry into the correct installation, servicing, repair or annual-support route." primaryLabel="Discuss Your Fire Requirements" audience="Commercial" serviceCategory="Fire & Compliance" enquiryType="General" sourceLabel="fire-compliance-final"/>
  </>
}
