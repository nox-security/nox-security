...
const services = [
  ...
  { title: "Perimeter protection", text: "External detection around approaches, side access, garages, yards and suitable boundary areas.", href: "/systems/perimeter-protection" },
