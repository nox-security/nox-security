...
const residentialSystems = [
  ...
  { title: "Perimeter Protection", text: "Suitable external detection for approaches, gates, boundaries and areas where earlier warning is useful.", href: "/systems/perimeter-protection", image: "/images/v4-12-6/perimeter-main-white-devices.png", alt: "Ajax perimeter protection devices presented together for residential security" },
