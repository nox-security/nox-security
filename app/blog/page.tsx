...
export default function BlogPage() {
  return <>
    <PageHero eyebrow="NOX advice and guides" title="Clear information before and after installation" intro="Practical guidance for homeowners, landlords and businesses considering new systems, ongoing servicing, fire-safety support or an existing-system takeover." image="/images/maintenance.png" imageAlt="NOX fire and security maintenance and advice"/>
    <TrustStrip/>
