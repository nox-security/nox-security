...
export default function ReviewsPage() {
  return <>
    ...
    <ReviewSummaryStrip/>
    <TrustStrip/>
    <section className="section"><div className="container"><SectionHeading eyebrow="Customer feedback" title="What customers say about working with NOX" text="The review wording below is taken from customer feedback previously supplied in the working NOX website project."/><ReviewGrid/><div className="button-row"><a className="button button-light" href="https://g.page/r/CUdyqRh0RFeXEAE/review" target="_blank" rel="noreferrer">View Google Reviews</a></div></div></section>
