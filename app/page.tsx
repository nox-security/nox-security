...
const ajaxProducts = [
  { name: "MotionCam", text: "Wireless motion detection with photo verification. Suitable models can add visual context after an alarm event, with the exact features confirmed during system design.", image: "/images/2Motioncam.jpg" },
  { name: "KeyPad TouchScreen", text: "A 5-inch touch interface for arming, groups and scenarios, with authentication by smartphone, Pass, Tag or code on compatible systems.", image: "/images/projects/chesterfield-home-keypad.jpg" },
  { name: "Hub 2 Plus", text: "The central unit connecting detectors, users, communication channels, app control and compatible visual-verification devices.", image: "/images/Ajax-Hub-2-Plus.webp" },
  { name: "DoorProtect", text: "Door and window opening detection selected around real entry routes, night mode and the way the household uses the property.", image: "/images/2Doorprotect.jpg" },
  { name: "Ajax NVR", text: "Network video recording for Ajax and compatible third-party IP cameras, with 8- or 16-channel options and storage selected around the project.", image: "/images/projects/bottle-thyme-nvr.jpg" },
  { name: "Ajax DoorBell", text: "Video entry with built-in AI, PIR detection, two-way voice and recording through a compatible Ajax NVR where included in the design.", image: "/images/AjaxDoorbell.jpeg" }
]
