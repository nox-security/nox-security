...
export default function HomePage() {
  ...
  return <>
    ...
    <section className="section service-plan-showcase"><div className="container">
      <SectionHeading eyebrow="Service plans" title="Monitoring, maintenance and compliance" text="Choose the system first, then add the ongoing support it needs." />
      <div className="service-plan-grid service-plan-grid-compact">
        <article><span>01</span><h3>Alarm Support</h3><p>Servicing, monitoring, takeovers and future upgrades.</p><Link href="/service-plans/alarm-maintenance">Alarm support →</Link></article>
        <article><span>02</span><h3>CCTV Support</h3><p>Cleaning, recording checks, remote viewing and takeovers.</p><Link href="/service-plans/cctv-maintenance">CCTV support →</Link></article>
        <article className="fire-plan-emphasis"><span>03</span><h3>Fire & Compliance</h3><p>Fire servicing, emergency lighting and compliance packages.</p><Link href="/service-plans/fire-compliance">Fire support →</Link></article>
      </div>
      <div className="service-plan-callout"><div><h3>Coordinated annual packages</h3><p>Combine eligible services under one clearer renewal structure.</p></div><Link className="button button-dark" href="/service-plans">View Service Plans</Link></div>
    </div></section>
