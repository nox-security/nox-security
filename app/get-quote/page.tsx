  ...
  return <>
    <section className="quote-hero-premium premium-enquiry-hero">
      <div className="container quote-hero-grid">
        <div><span className="eyebrow">Start your NOX enquiry</span><h1>Get a Fire & Security quote</h1><p className="lead">Tell us about the property, site or existing system. A few clear details are enough for the NOX team to understand the requirement and contact you directly.</p></div>
