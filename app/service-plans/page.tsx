...
const primarySupport = [
  ...
  { title: "CCTV Maintenance", text: "Camera cleaning, image checks, recorder and storage health, playback, remote access and upgrade recommendations.", href: "/service-plans/cctv-maintenance", image: "/images/revisions/buxton-commercial-cctv-monitor.jpg", alt: "Commercial CCTV system checked for recording and playback during maintenance" },
  { title: "System Takeovers", text: "Assessment of access, faults, condition, compatibility and the practical route into ongoing support.", href: "/services/security-system-takeover", image: "/images/revisions/cctv-system-takeover-upgrade.jpg", alt: "Older CCTV equipment removed during a security system takeover" },
  { title: "Repairs & Upgrades", text: "Fault assessment, selective replacement, recorder upgrades, access recovery and phased system improvement.", href: "/services/repairs-upgrades", image: "/images/revisions/nox-engineer-cctv-wiring.jpg", alt: "NOX engineer repairing and upgrading commercial CCTV cabling" },
]
