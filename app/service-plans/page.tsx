...
const primarySupport = [
  ...
  { title: "Alarm Monitoring", text: "Professional signalling, keyholder communication and system supervision for suitable maintained alarm systems.", href: "/service-plans/alarm-monitoring", image: "/images/v4-13-2/alarm-monitoring-operator.jpg", alt: "Close-up of a professional alarm monitoring operator wearing a headset" },
...
export default function ServicePlansPage() {
  return <>
    ...
    ]}/><div className="commercial-route-links"><Link href="/service-plans/total-security">Total Security Plans →</Link><Link href="/service-plans/fire-compliance">Fire Compliance Plans →</Link></div></div></section>
