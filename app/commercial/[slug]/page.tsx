...
const pages: Record<string, CommercialPage> = {
  ...
  "yard-perimeter-security": {
    ...
    alt: "NOX van at an industrial yard during perimeter alarm protection work near Dronfield",
