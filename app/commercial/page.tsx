...
export default function CommercialPage() {
  return <>
    ...
    <section className="section"><div className="container">
      <SectionHeading eyebrow="Servicing & support" title="Move existing and newly installed systems into a clearer support route" text="Suitable existing and newly installed systems can move into planned servicing, monitoring, repairs, phased upgrades and takeover support without being forced into an unnecessary replacement."/>
