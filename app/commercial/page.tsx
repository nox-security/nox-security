...
export default function CommercialPage() {
  return <>
    ...
    <section className="section"><div className="container"><SectionHeading eyebrow="Customer feedback" title="Site-specific advice, professional installation and local follow-up"/><ReviewGrid limit={3}/></div></section>
