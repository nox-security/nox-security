...
export default function SystemsPage() {
  return <>
    <PageHero eyebrow="NOX solutions" title="Alarm, CCTV and Fire systems designed around the property" intro="Choose the service you need and use one clear enquiry route. NOX will review the property and arrange a survey where the system needs to be designed on site." image="/images/intrusion-alarms.png" imageAlt="NOX alarm, CCTV and fire security solutions in Chesterfield"><DualButtons/></PageHero>
    <TrustStrip/>
