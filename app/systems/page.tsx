...
export default function SystemsPage() {
  return <>
    ...
    </div><aside className="dark-panel"><span className="eyebrow">Packages and annual support</span><h3>One point of contact after handover</h3><p>Where the confirmed scope allows, services can be coordinated under one renewal structure with planned engineer visits, consistent records and direct support for repairs or upgrades.</p><Link className="button button-light" href="/service-plans">Explore Service & Monitoring</Link></aside></div></section>
