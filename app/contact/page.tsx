...
export default function ContactPage() {
  return <>
    <section className="contact-hero-premium"><div className="container contact-premium-grid"><div><span className="eyebrow">Contact NOX</span><h1>Speak to the local team responsible for the project</h1><p className="lead">Use the enquiry form for a new system, servicing, Fire support, a repair or an existing-system takeover. Your details are reviewed directly by NOX rather than passed through a national call centre.</p></div><div className="contact-image-panel"><img src="/images/team/124080D8-A51E-43FC-BD1D-991478E87DA9.jpeg" alt="NOX Fire & Security representative with Ajax intruder, CCTV and perimeter products"/><div className="contact-image-caption"><strong>NOX Fire & Security</strong><span>{site.base}</span><span>Ajax security · Commercial Fire systems · Local aftercare</span></div></div></div></section>
