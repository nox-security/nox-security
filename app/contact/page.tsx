...
export default function ContactPage() {
  return <>
    <section className="contact-hero-premium"><div className="container contact-premium-grid"><div><span className="eyebrow">Contact NOX</span><h1>Speak to the local team responsible for the project</h1><p className="lead">Use the enquiry form for a new system, servicing, Fire support, a repair or an existing-system takeover. Your details are reviewed directly by NOX rather than passed through a national call centre.</p></div><div className="contact-image-panel"><img src="/images/resent-installation/8F92B8AB-DE21-4FF1-B93F-EC455580264F.png" alt="NOX Fire and Security external sounder installed at a customer property"/><div className="contact-image-caption"><strong>NOX Fire & Security</strong><span>{site.base}</span><span>Premium residential · Commercial Fire & Security</span></div></div></div></section>
