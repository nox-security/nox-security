...
export default function ContactPage() {
  return <>
    <section className="contact-hero-premium"><div className="container contact-premium-grid"><div><span className="eyebrow">Contact NOX</span><h1>Speak to the local team responsible for the project</h1><p className="lead">Use the enquiry form for a new system, servicing, Fire support, a repair or an existing-system takeover. Your details are reviewed directly by NOX rather than passed through a national call centre.</p></div><div className="contact-image-panel"><img src="/images/editorial/contact-team.jpg" alt="NOX Fire and Security van attending a residential property in Derbyshire"/><div className="contact-image-caption"><strong>NOX Fire & Security</strong><span>{site.base}</span><span>Residential surveys · Commercial projects · Local aftercare</span></div></div></div></section>
